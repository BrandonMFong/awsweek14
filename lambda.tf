...
# +cbb
  statement {
    ...
    resources = [
      aws_secretsmanager_secret.week14-secret.arn
    ]
  }
# -cbb
...
resource "aws_iam_role_policy_attachment" "week14-lambda-automation-role" {
...
resource "aws_lambda_function" "lambda" {
  ...
  vpc_config {
    ...
    security_group_ids = [aws_security_group.week14-ssh-sg-v2.id]
  }
}
